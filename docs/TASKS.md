...
- All previously completed cards were removed from this file on `2026-03-19`.
- Add new work below using the template so each card is implementation-ready with minimal recall.
