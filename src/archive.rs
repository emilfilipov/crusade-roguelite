    ...
    let mut entries = vec![
        ArchiveEntry {
            ...
            description: format!(
                ...
                data.units.commander.max_hp,
                data.units.commander.armor,
                data.units.commander.damage,
                data.units.commander.aura_radius,
            ),
            icon: None,
        },
        ArchiveEntry {
        ...
        ArchiveEntry {
            ...
            title: "Bandit Raider".to_string(),
            description: format!(
                "Melee enemy. HP {}, Damage {}, Move {}.",
                data.enemies.bandit_raider.max_hp,
                data.enemies.bandit_raider.damage,
                data.enemies.bandit_raider.move_speed,
            ),
            icon: None,
        },
        ArchiveEntry {
