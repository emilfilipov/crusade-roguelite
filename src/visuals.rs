...
fn load_art_assets(mut assets: ResMut<ArtAssets>, asset_server: Option<Res<AssetServer>>) {
    ...
    assets.commander_saladin_idle = asset_server
        .load("third_party/kenney_desert-shooter-pack_1.0/PNG/Players/Tiles/tile_0010.png");
    ...
    assets.muslim_peasant_infantry_idle = asset_server
        .load("third_party/kenney_desert-shooter-pack_1.0/PNG/Players/Tiles/tile_0008.png");
    assets.muslim_peasant_infantry_rescuable_variant = asset_server
        .load("third_party/kenney_desert-shooter-pack_1.0/PNG/Players/Tiles/tile_0008.png");
    assets.muslim_peasant_archer_idle = asset_server
        .load("third_party/kenney_desert-shooter-pack_1.0/PNG/Players/Tiles/tile_0009.png");
    assets.muslim_peasant_archer_rescuable_variant = asset_server
        .load("third_party/kenney_desert-shooter-pack_1.0/PNG/Players/Tiles/tile_0009.png");
    assets.muslim_peasant_priest_idle = asset_server
        .load("third_party/kenney_desert-shooter-pack_1.0/PNG/Players/Tiles/tile_0011.png");
